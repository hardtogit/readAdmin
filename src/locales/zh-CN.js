...
export default {
  ...
  'menu.home': '首页',
  'menu.goods': '运营管理',
  'menu.goods.goodsManage': '商品管理',
  'menu.goods.goodsDetail': '商品表单',
  'menu.goods.typeManage': '类型管理',
  'menu.goods.orderManage': '订单管理',
  'menu.goods.bannerManage': '素材管理',
  'menu.coupon':'券类管理',
  'menu.coupon.discountCouponManage':'优惠券管理',
  'menu.coupon.integralCouponManage':'积分卡模板管理',
  'menu.coupon.goldManage':'积分卡管理',
  'menu.power':'权限管理',
  'menu.power.accountManage':'账号管理',
  'menu.power.roleManage':'角色管理',
  'menu.power.freightManage':'邮费管理',
  'menu.callCenter':'客服中心',
  'menu.form': '表单页',
